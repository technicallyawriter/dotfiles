...
-- Define Pulse Audio for volume-control widget in wibar - https://github.com/deficient/volume-control
volumecfg = volume_control {device="pulse"}
-- SEPARATORS FOR WIBAR WIDGETS
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized("/home/technicallyawriter/Pictures/work.jpeg", s)
    end
end
...
globalkeys = gears.table.join(
	...
	-- ADJUST VOLUME (volume-control widget - https://github.com/deficient/volume-control)
	...
	-- Signal
	awful.key({ modkey }, "s", function () awful.util.spawn("signal-desktop") end),
	-- i3lock
